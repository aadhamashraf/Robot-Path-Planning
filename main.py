...
def main():
    ...
    def solve_greedy_bfs(metric, metric_name):
        ...
        path, frontier, step_count, elapsed_time = Heuristic_Search.greedy_bfs(maze, start_pos, goal_pos, metric)
        comparewell.export_frontier(frontier, f"Greedy BFS ({metric_name})")
        compareAlgos[f"Greedy BFS ({metric_name})"] = [elapsed_time, step_count]
    ...
    def solve_simulated_annealing():
        ...
        path, frontier, step_count, elapsed_time = Local_Search.simulated_annealing(maze, start_pos, goal_pos)
    ...
    def solve_genetic_algorithm():
        ...
        path, frontier, step_count, elapsed_time = Local_Search.genetic_algorithm(maze, start_pos, goal_pos)
    ...
    buttons_properties = [
        ...
        ('UCS', button_x, button_y + 2 * (button_height + button_gap), button_width, button_height, None, solve_ucs),
        
        ('IDS', button_x, button_y + 3 * (button_height + button_gap), button_width - 60, button_height, None, None),
        ('-', button_x + button_width - (button_width / 8) - 42, button_y + 3 * (button_height + button_gap),button_width / 8, button_height, None, decreaseL),
        ('+', button_x + button_width - (button_width / 8), button_y + 3 * (button_height + button_gap),button_width / 8, button_height, None, increaseL),
        
        ('Greedy BFS (Manhattan)', button_x, button_y + 4 * (button_height + button_gap), button_width, button_height, None,lambda: solve_greedy_bfs(manhattan_metric, "Manhattan")),
        ('Greedy BFS (Euclidean)', button_x, button_y + 5 * (button_height + button_gap), button_width, button_height, None,lambda: solve_greedy_bfs(euclidean_metric, "Euclidean")),
        
        ('A* (Manhattan)', button_x, button_y + 6 * (button_height + button_gap), button_width, button_height, None,lambda: solve_a_star(manhattan_metric, "Manhattan")),
        ('A* (Euclidean)', button_x, button_y + 7 * (button_height + button_gap), button_width, button_height, None,lambda: solve_a_star(euclidean_metric, "Euclidean")),
        
        ('Hill Climbing', button_x, button_y + 8 * (button_height + button_gap), button_width, button_height, None,solve_hill_climbing),
        ('Simulated Annealing', button_x, button_y + 9 * (button_height + button_gap), button_width, button_height, None,solve_simulated_annealing),
        ('Genetic Algorithm', button_x, button_y + 10 * (button_height + button_gap), button_width, button_height, None,solve_genetic_algorithm),
        ('Compare Algos', button_x, button_y + 11 * (button_height + button_gap), button_width, button_height, None,compare_execution_time),
        ('Reset Path', button_x, button_y + 12 * (button_height + button_gap), button_width, button_height, None,reset_path),
        ('Reset Maze', button_x, button_y + 13 * (button_height + button_gap), button_width, button_height, None,reset_maze)
    ]
    ...
    while running:
        ...
        screen.blit(lValue, (button_x + button_width - (button_width *2.7 / 8) , button_y + 3 * (button_height + button_gap) + 12.5))
        pygame.display.flip()
